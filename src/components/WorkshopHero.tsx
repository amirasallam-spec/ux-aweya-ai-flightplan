        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="flex flex-wrap gap-4 mb-6">
            ...
            <div className="bg-card/80 backdrop-blur-sm rounded-2xl px-6 py-4 shadow-sm border border-border">
              ...
              <p className="text-lg font-bold text-foreground">7 Modules Recorded, 50+ Lessons, 6 Online Sessions</p>
            </div>
          </div>
          ...
          <div className="hidden lg:flex flex-col justify-end items-center relative">
            ...
            <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-10">
              <div className="bg-card/90 backdrop-blur-md border border-border px-6 py-3 rounded-2xl shadow-xl">
                ...
                <p className="text-sm text-foreground font-semibold whitespace-nowrap">UX Lead</p>
                <p className="text-sm text-foreground whitespace-nowrap">Thomson Reuters, AI Products</p>
              </div>
            </div>
          </div>
        </div>
